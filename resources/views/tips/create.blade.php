...
@section('title', 'Pridať tip — TipVerify')

@section('content')

    <div class="max-w-xl">
        <h1 class="text-2xl font-bold mb-6">Pridať nový tip</h1>
            ...
            <form method="POST" action="/tips">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="match_teams" name="match_teams"
                           value="{{ old('match_teams') }}"
                           placeholder="napr. Real Madrid vs Barcelona"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="prediction" name="prediction"
                           value="{{ old('prediction') }}"
                           placeholder="napr. Over 2.5 gólov"
                           class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('prediction')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
